...
import com.hz.bus.entity.Sales;
import com.hz.bus.service.ICustomerService;
import com.hz.bus.service.IGoodsService;
import com.hz.bus.service.ISalesService;
import com.hz.bus.vo.SalesVo;
import com.hz.sys.common.DataGridView;
import com.hz.sys.common.ResultObj;
import com.hz.sys.common.WebUtils;
...
public class SalesController {
    ...
    public ResultObj addSales(SalesVo salesVo){
        try {
            ...
            if(salesService.save(salesVo)){
                return ResultObj.ADD_SUCCESS;
            }
            return ResultObj.SALE_ERROR;
        }catch (Exception e) {
            e.printStackTrace();
            return ResultObj.SALE_ERROR;
        }
